  ...
  if (tnow-lastfilttime)>filter_delay:
    ...
    if message is not None:
        ...
        if index>1:
          ...
          ax_tilt[3]=math.asin(ax_tilt[3])
          ay_tilt[3]=-den2[1]*ay_tilt[2]-den2[2]*ay_tilt[1]+num2[1]*ax_raw[2]+num2[2]*ax_raw[1]
          ay_tilt[3]=math.asin(ay_tilt[3])
          anglex[3]=ax_tilt[3]+anglexraw
          angley[3]=ay_tilt[3]+angleyraw
          anglex_filtered[3]=-den3[1]*anglex_filtered[2]-den3[2]*anglex_filtered[1]+anglex[2]+num3[1]*anglex[1]+num3[2]*anglex[0]
          angley_filtered[3]=-den3[1]*angley_filtered[2]-den3[2]*angley_filtered[1]+angley[2]+num3[1]*angley[1]+num3[2]*angley[0]
        ...
        command = [x_desired[-1],y_desired[-1],z_desired[-1],anglex[-1]+ax_tilt[-1],angley[-1]+ay_tilt[-1],anglez_filtered[-1]]
    ...
    if tnow-lastsendtime>arduino_delay:
      print "sent: "+format(command[0],'0.2f')+","+format(command[1],'0.2f')+","+format(command[2],'0.2f')+","+format(command[3],'0.2f')+","+format(command[4],'0.2f')+","+format(command[5],'0.2f')
