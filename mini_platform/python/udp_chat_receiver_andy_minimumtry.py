...
while 1:
  ...
  (num3,den3,dt3) = cont2discrete(([1,0,0],[1,7,50]),dt)
  #print num3,den3
  #az to z_desired
  ...
  if message is not None:
      ...
      if index>1:
        #print num1[2]
        y_desired[index]=-den1[1]*y_desired[index-1]-den1[2]*y_desired[index-2]+num1[1]*ax_raw[index-1]+num1[2]*ax_raw[index-2]
        x_desired[index]=-den1[1]*x_desired[index-1]-den1[2]*x_desired[index-2]+num1[1]*ay_raw[index-1]+num1[2]*ay_raw[index-2]
