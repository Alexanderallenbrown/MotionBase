...
def testCallback(userdata, timestamp, report):
    ...
    #own.position[0] = own.position[0]+report.contents.pose.translation.data[0]
    #own.position[1] = own.position[1]+report.contents.pose.translation.data[1]
    #own.position[2] = own.position[2]+report.contents.pose.translation.data[2]\
