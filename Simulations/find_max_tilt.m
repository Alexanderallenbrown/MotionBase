...
for i=1:length(anglex)
   ...
   [length1,l1,length2,l2,length3,l3,length4,l4,length5,l5,length6,l6,Bx,By,Bz,Tx,Ty,Tz]=traj(0,0,z_default,anglex(i),0,0); 
   L1=[L1,length1];
   L2=[L2,length2];
   L3=[L3,length3];
   L4=[L4,length4];
...
figure(1)
plot(anglex,error1,anglex,error2,anglex,error3,anglex,error4,anglex,error5,anglex,error6)
xlabel('roll')
ylabel('error(m)')
legend('1','2','3','4','5','6')
...
plot(anglex,a1,anglex,a2,anglex,a3,anglex,a4,anglex,a5,anglex,a6)
