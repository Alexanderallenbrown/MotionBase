...
% L is the vector that records the leg length for legs 1-6
L1=[];
L2=[];
L3=[];
L4=[];
...
% a is the vector that records the angle of the short leg for legs 1-6
a1=[];
a2=[];
a3=[];
a4=[];
...
% x y z coordinates for points 1-6
x1=[];
y1=[];
z1=[];
error1=[];
...
% forces in the connecting rods (long legs ?) 1-6
F1=[];
F2=[];
F3=[];
F4=[];
...
for i=1:length(xdesired)
    ...
    [l, Length, Bx, By, Bz, Tx, Ty, Tz]=traj(motion_des(i,:),angle_des(i,:)); 
