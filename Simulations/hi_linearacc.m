...
for i=1:length(time1)
   ...
   [length1,l1,length2,l2,length3,l3,length4,l4,length5,l5,length6,l6,Bx,By,Bz,Tx,Ty,Tz]=traj(xdesired(i),0,1,0,aytilt(i),0); 
   L1=[L1,length1];
   L2=[L2,length2];
   L3=[L3,length3];
   L4=[L4,length4];
...
figure(1)
plot(time1,error1,time1,error2,time1,error3,time1,error4,time1,error5,time1,error6)
xlabel('time')
ylabel('error(m)')
legend('1','2','3','4','5','6')

figure(2)
plot(zdesired,error4)
xlabel('ydisplacement')
ylabel('error4(m)')
